	...
	<table cellspacing="0" cellpadding="0" width="100%" align="center">
		<tr>
			<td class="Heading1">
                ...
                <div class="Heading1Image"><img src="images/headerimages/import_contacts.jpg" alt="%%LNG_Subscribers_Import_Step2%%" /></div><div class="Heading1Text">%%LNG_Subscribers_Import_Step2%%</div><div class="Heading1Links"> <a href="#"><img src="images/help2.gif" alt="Help" border="0" /></a><a href="#"><img src="images/bulb.jpg" alt="Tip" border="0" /></a></div>
			</td>
		</tr>
		<tr>
			<td class="body pageinfo">
			<p>
				%%LNG_Subscribers_Import_Step2_Intro%%&nbsp;<a href="#" onClick="LaunchHelp('817'); return false;">%%LNG_ImportTutorialLink%%</a>
			</p>
			</td>
		</tr>
		<tr>
				...
				<table border="0" cellspacing="0" cellpadding="2" width="100%" class="Panel">
					...
					<!-- here we go for importing of files. //-->
						...
						<tr>
							...
							<td>
								<div>
									<input id="SubscriberImportUseUpload" type="hidden" name="useserver" value="0" checked="checked" onClick="FileSourceFromServer(false);" />
								</div>
