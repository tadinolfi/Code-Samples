<form method="post" action="index.php?Page=Send&Action=Step3">
	<table cellspacing="0" cellpadding="0" width="100%" align="center">
		<tr>
			<td class="Heading1">
				<div class="Heading1Image"><img src="images/headerimages/%%LNG_Send_Step2%%.jpg" alt="%%LNG_Send_Step2%%" /></div><div class="Heading1Text">%%LNG_Send_Step2%%</div><div class="Heading1Links"> <a href="#"><img src="images/help2.gif" alt="Help" border="0" /></a><a href="#"><img src="images/bulb.jpg" alt="Tip" border="0" /></a></div>
			</td>
		</tr>
		<tr>
			<td class="body pageinfo">
				<p>
					%%LNG_Send_Subscribers_Search_Step2%%
				</p>
			</td>
		</tr>
		<tr>
					...
					<tr>
						...
						<td>
							<select name="confirmed" class="Field250">
								<option value="-1">%%LNG_Either_Confirmed%%</option>
								<option value="1" SELECTED>%%LNG_Confirmed%%</option>
