...
<script type="text/javascript">
	...
	Application.Page.TriggerEmailsForm = {
		_language: {	trigger_name_empty: '{$lang.TriggerEmails_Form_Field_TriggerName_Error|addslashes}',
						...
						triggertype_datecustomfields_instruction: '{$lang.TriggerEmails_Form_Field_TriggerType_DateCustomField_ChooseList_Instruction|addslashes}',
...
<div class="PageBodyContainer">
	<div class="Heading1"><div class="Heading1Image"><img src="images/headerimages/autoresponders_triggers_email.jpg" alt="{$lang.TriggerEmails_Manage}" /></div><div class="Heading1Text">{$lang.TriggerEmails_Manage}</div><div class="Heading1Links"> <a href="#"><img src="images/help2.gif" alt="Help" border="0" /></a><a href="#"><img src="images/bulb.jpg" alt="Tip" border="0" /></a></div></div>
								...
								{* ----- When trigger do the following actions *}
									<tr>
										...
										<td>
											...
											<div>
												<div>
													<input type="checkbox" name="record[triggeractions][addlist][enabled]" id="triggeremails_triggeractions_addlist_enabled" class="triggeractions" value="1" {if $record.triggeractions.addlist}checked="checked"{/if} />
													<label for="triggeremails_triggeractions_addlist_enabled">
														{$lang.TriggerEmails_Form_Field_TriggerAction_AddList}
													</label>
												</div>
												<div id="triggeremails_triggeractions_addlist_options" {if !$record.triggeractions.addlist}style="display:none;"{/if}>
											...
											<table cellspacing="0" cellpadding="0">
												<tr>
													<td valign="top">
														<input type="checkbox" name="record[triggeractions][removelist][enabled]" id="triggeremails_triggeractions_removelist_enabled" class="triggeractions" value="1" {if $record.triggeractions.removelist}checked="checked"{/if} />
														&nbsp;
													</td>
													<td valign="top">
									...
									<td>
										<select name="record[triggeractions][send][firstnamefield]" class="Field250">
											...
											{foreach from=$availableNameCustomFields item=each}
												<option value="{$each.listid}" {if $record.triggeractions.send.firstnamefield == $each.fieldid}selected="selected"{/if}>{$each.name|htmlspecialchars, ENT_QUOTES, SENDSTUDIO_CHARSET}</option>
											{/foreach}
										</select>
								...
								<tr>
									...
									<td>
										<select name="record[triggeractions][send][lastnamefield]" class="Field250">
											...
											{foreach from=$availableNameCustomFields item=each}
												<option value="{$each.listid}" {if $record.triggeractions.send.lastnamefield == $each.fieldid}selected="selected"{/if}>{$each.name|htmlspecialchars, ENT_QUOTES, SENDSTUDIO_CHARSET}</option>
											{/foreach}
										</select>
