...
<form name="frmSendStep3" method="post" action="index.php?Page=Send&Action=Step4">
	<table cellspacing="0" cellpadding="0" width="100%" align="center">
		<tr>
			<td class="Heading1">
				<div class="Heading1Image"><img src="images/headerimages/%%LNG_Send_Step3%%.jpg" alt="%%LNG_Send_Step3%%" /></div><div class="Heading1Text">%%LNG_Send_Step3%%</div><div class="Heading1Links"> <a href="#"><img src="images/help2.gif" alt="Help" border="0" /></a><a href="#"><img src="images/bulb.jpg" alt="Tip" border="0" /></a></div>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<table border="0" cellspacing="0" cellpadding="2" width="100%" class="Panel">
					...
					<tr style="display:none">
						...
						<tr>
							<td  colspan="2" style="padding:10px 0 10px 15px"><img style="vertical-align:middle" src="images/warning.gif" border="0" />&nbsp;<span style="font-weight:bold">DO NOT</span> check this option if you do not (or are not sure if) you have Google Analytics installed on your website. We encourage thorough testing of this option. To learn more click <a target="_blank" href="http://help.sendlabs.com/questions/109/How+do+I+use+Google+Analytics+with+my+email+campaigns%3F">here</a></td>
						</tr>
					</table>
