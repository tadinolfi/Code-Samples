...
<table cellspacing="0" cellpadding="0" width="100%" align="center">
	<tr>
		<td>
			...
			<div class="Heading1">
                <div class="Heading1Image"><img src="images/headerimages/search_for_contacts.jpg" alt="%%LNG_View%%" /></div><div class="Heading1Text">%%LNG_View%%:
                ...
                </div><div class="Heading1Links"> <a href="#"><img src="images/help2.gif" alt="Help" border="0" /></a><a href="#"><img src="images/bulb.jpg" alt="Tip" border="0" /></a></div>
			</div>
		</td>
	</tr>
	<tr>
		...
		<td class="body">
			<form name="ActionMembersForm" method="post" action="index.php?Page=Subscribers&Action=Manage&SubAction=Change&List=%%GLOBAL_List%%" onsubmit="return ConfirmChanges();">
				<table width="100%" border="0">
					<tr>
						<td style="display:%%GLOBAL_AddButtonDisplay%%"><input type="button" name="cmdAddContact" value="%%LNG_Subscribers_Add_Button%%" class="SmallButton" /></td>
					</tr>
					<tr>
						<td valign="bottom">
							<div>
