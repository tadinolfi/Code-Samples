...
<script>
	...
	$(function() {
		...
		$('.CustomFieldDateInput_Row').each(function() {
			...
			var minYear = year.options[0].value;
	...
	<table cellspacing="0" cellpadding="0" width="100%" align="center">
		<tr>
			<td class="Heading1">
                ...
                <div class="Heading1Image"><img src="images/headerimages/add_a_contact.jpg" alt="%%GLOBAL_Heading%%" /></div><div class="Heading1Text">%%GLOBAL_Heading%%</div><div class="Heading1Links"> <a href="#"><img src="images/help2.gif" alt="Help" border="0" /></a><a href="#"><img src="images/bulb.jpg" alt="Tip" border="0" /></a></div>
			</td>
		</tr>
		<tr>
