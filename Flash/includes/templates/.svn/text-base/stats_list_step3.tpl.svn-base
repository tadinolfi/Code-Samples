...
<div class="Heading1">
<div class="Heading1Image"><img src="images/headerimages/Email Campaign Statistics.jpg" alt="Stats" /></div><div class="Heading1Text">%%LNG_Stats_ListStatistics%%</div><div class="Heading1Links"> <a href="#"><img src="images/help2.gif" alt="Help" border="0" /></a><a href="#"><img src="images/bulb.jpg" alt="Tip" border="0" /></a></div>
</div>
...
<table width="100%" border="0" class="Text">
	<tr>
		<td valign=top width="250" rowspan="2">
			<div class="MidHeading" style="width:100%"><img src="images/m_stats.gif" width="20" height="20" align="absMiddle">&nbsp;Contact Summary</div>
				<UL class="Text">
