	...
	<table cellpadding="0" cellspacing="0" width="100%" class="Text" style="margin:0; padding:0;">
		<tr class="GridRow" style="cursor:pointer;">
			...
			<td width="240" class="HideOnDrag">
				{if $folder_id !== '0'}
				<a href="#" onclick="tb_show('{$lang.Folders_RenameFolder}', 'index.php?Page=Folders&Action=Rename&FolderID=%%GLOBAL_FolderID%%&FolderName=%%GLOBAL_FolderName_Encoded%%&keepThis=true&TB_iframe=true&height=80&width=325', '');">Rename</a>
				<a href="#" onclick="Application.Ui.Folders.RemoveFolder(%%GLOBAL_FolderID%%);">Delete</a>
				{/if}
				&nbsp;
			</td>
		</tr>
