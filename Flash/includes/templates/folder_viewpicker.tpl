...
<div style="position:relative; display:inline; top:4px;">
	{if $mode == 'Folder'}
		...
		<a href="#" onclick="tb_show('Add Folder', 'index.php?Page=Folders&Action=Add&FolderType=list&keepThis=true&TB_iframe=true&height=80&width=325', '');"><img src="images/folder_add.gif" width="25" height="20" alt="%%LNG_Folders_AddFolder%%" title="%%LNG_Folders_AddFolder%%" border="0" /></a>
	{else}
