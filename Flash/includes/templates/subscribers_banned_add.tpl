	...
	<table cellspacing="0" cellpadding="0" width="100%" align="center">
		<tr>
			<td class="Heading1">
                ...
                <div class="Heading1Image"><img src="images/headerimages/supression_list.jpg" alt="%%LNG_Subscribers_Banned_Add%%" /></div><div class="Heading1Text">%%LNG_Subscribers_Banned_Add%%</div><div class="Heading1Links"> <a href="#"><img src="images/help2.gif" alt="Help" border="0" /></a><a href="#"><img src="images/bulb.jpg" alt="Tip" border="0" /></a></div>
			</td>
		</tr>
		<tr>
