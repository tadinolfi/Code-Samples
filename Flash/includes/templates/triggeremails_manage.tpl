	...
	Application.Page.TriggerEmailsManage = {
		eventDOMReady: function(event) {
			...
			if($('#triggeremails_record_list').size() != 0) {
				Application.Ui.CheckboxSelection(	'#triggeremails_record_list input.UICheckboxToggleSelector',
													'#triggeremails_record_list input.UICheckboxToggleRows');
