	...
	public class TweenLite {
		...
		public function initTweenVals():void {
			...
			if (this.target is Array) {
				...
				for (p in this.vars) {
					if (p == "delay" || p == "ease" || p == "overwrite" || p == "onComplete" || p == "onCompleteParams" || p == "runBackwards" || p == "onUpdate" || p == "onUpdateParams" || p == "autoAlpha" || p == "_autoAlpha" || p == "onStart" || p == "onStartParams" || p == "easeParams" || p == "mcColor") {
